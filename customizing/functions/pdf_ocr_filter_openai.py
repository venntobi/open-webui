...
class Filter:
    def __init__(
        self,
        model_deployment_name=os.getenv("OPENAI_DEPLOYMENT_NAME", "DEPLOYMENT_NAME"),
        model_api_key=os.getenv("OPENAI_API_KEY", "API_KEY"),
    ):
    ...
    def vision_ocr(self, input_text_or_image):
